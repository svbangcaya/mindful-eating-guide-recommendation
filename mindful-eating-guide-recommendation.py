    ...
    "Portion Control": [
        {
            ...
            "fact": "Did you know that yoga can improve body awareness and mindfulness, helping to control portion sizes? (Source: Yoga Journal)"
        },
        {
            "activity": "Walking",
            "description": "Walking regularly can help manage weight and improve overall health.",
            "fact": "Did you know that walking for just 30 minutes a day can reduce the risk of obesity and related diseases? (Source: Mayo Clinic)"
        }
    ],
    "Emotional Eating": [
        {
            "activity": "Meditation",
            "description": "Meditation can help reduce stress and improve emotional regulation, reducing emotional eating.",
            "fact": "Did you know that regular meditation can lower stress levels and decrease the frequency of emotional eating episodes? (Source: American Psychological Association)"
        },
        {
            "activity": "Journaling",
            "description": "Writing about your feelings can be a healthy way to process emotions and reduce the urge to eat for comfort.",
            "fact": "Did you know that journaling can help identify emotional triggers and develop healthier coping strategies? (Source: Journal of Clinical Psychology)"
        }
    ],
    "Binge Eating": [
        {
            ...
            "fact": "Did you know that regular running can reduce stress and improve mood, helping to control binge eating? (Source: Journal of Adolescent Health)"
        },
        {
            "activity": "Strength Training",
            "description": "Strength training can boost your metabolism and help control your appetite.",
            "fact": "Did you know that strength training can increase muscle mass and metabolism, making it easier to manage weight? (Source: American College of Sports Medicine)"
        }
    ],
    "General Tips": [
        {
            ...
            "fact": "Did you know that swimming can burn a significant amount of calories and is an excellent cardiovascular exercise? (Source: Centers for Disease Control and Prevention)"
        },
        {
            "activity": "Cycling",
            "description": "Cycling is a fun way to stay active and maintain overall fitness.",
            "fact": "Did you know that cycling can improve cardiovascular health and help maintain a healthy weight? (Source: British Medical Journal)"
        }
    ]
}
